...
<meta charset="utf-8">
  ...
  <body>
    <input name="origenEscogido" id="origen" class="controls" type="text"
        placeholder="Introduce una localización de origen">

    <input name="destinoEscogido" id="destino" class="controls" type="text"
        placeholder="Introduce una localización de destino">

    <div id="mode-selector" class="controls">
      <input type="radio" name="type" id="changemode-walking" checked="checked">
      <label for="changemode-walking">Andando</label>

      <input type="radio" name="type" id="changemode-transit">
      <label for="changemode-transit">Transporte público</label>

      <input type="radio" name="type" id="changemode-driving">
      <label for="changemode-driving">Coche</label>
    </div>
    ...
    <script>
      ...
      elemento.getAttribute('origen');
      elemento.getAttribute('destino');
      elemento.setAttribute("origen", "origenDicho"); */
      ...
      AutocompleteDirectionsHandler.prototype.route = function() {
        ...
        this.directionsService.route({
          ...
          if (status === 'OK') {
            ...
            window.alert('Solicitud de dirección fallido debido a ' + status);
          }
        });
      };
